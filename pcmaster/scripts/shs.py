...
# ---------------------------------------------------------------------------
secreto_sistema = obtener_setting("secreto_sistema", "r0xym4st3r_s3cr3t0_k3y_v83")
...
def firmar_payload(payload: dict) -> dict:
    """
    ...
    firma = hmac.new(secreto_bytes, msg_bytes, hashlib.sha256).hexdigest()
...
def verificar_payload(payload: dict) -> bool:
    """
    ...
    try:
        ...
        firma_calculada = hmac.new(secreto_bytes, msg_bytes, hashlib.sha256).hexdigest()
