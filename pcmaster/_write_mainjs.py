# -*- coding: utf-8 -*-
# script temporal para escribir main.js
import os, sys
sys.stdout.reconfigure(encoding='utf-8')

content = r"""/* ===== main.js - roxymaster frontend ===== */
(function() {
  'use strict';
...
path = os.path.join(os.path.dirname(__file__) or '.', 'publico', 'js', 'main.js')
os.makedirs(os.path.dirname(path), exist_ok=True)
with open(path, 'w', encoding='utf-8') as f:
    f.write(content)
print('main.js written successfully,', os.path.getsize(path), 'bytes')