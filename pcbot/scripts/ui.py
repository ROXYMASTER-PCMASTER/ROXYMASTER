        ...
        with ui.column().classes('w-full gap-4 p-4'):
            ...
            with ui.card().classes('w-full bg-white shadow-md'):
                with ui.row().classes('w-full gap-4'):
                    ...
                    ui_elements["estado_label"] = ui.label("⏳ Inicializando...").classes('text-sm text-gray-600')
...
# Conectar al servidor local en background (se inicia cuando NiceGUI arranca su event loop)
ui.timer(0.1, lambda: asyncio.create_task(conectar_servidor_local()), once=True)
